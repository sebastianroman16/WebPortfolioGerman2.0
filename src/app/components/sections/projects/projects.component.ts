...
export class ProjectsComponent {
  readonly projects: Project[] = [
    ...
    },
    {
      ...
      summary:
        'Timed red/yellow/green sequencing with clock division and safe state transitions.',
      details:
        'This project involved designing a traffic light control system using VHDL. The objective was to create a reliable and timed sequence for red, yellow, and green lights using digital logic.\n\nA finite state machine was implemented to represent each traffic light state. Clock division logic was added to generate realistic timing intervals from the system clock.\n\nEach state activated the appropriate light outputs, and transitions occurred automatically based on timing conditions. The design ensured that conflicting signals were never active at the same time.\n\nSimulation was used to verify timing accuracy and proper sequencing. The waveform outputs confirmed correct state progression and signal behavior.\n\nThe final system demonstrated robust synchronous control and proper FSM design using VHDL.',
      stack: ['VHDL', 'FSM', 'Simulation'],
      year: '2025',
    ...
    },
    {
      ...
      summary:
        'Interactive GUI for Bode, root locus, margins, and step response with metrics.',
      details:
